...
create table Orders(
order_id int primary key,order_date date,customer_id int,total_amount NUMERIC(10, 2),foreign key (customer_id)references Customers(customer_id));
create table OrderDetails(
order_detail_id int primary key,order_id int,product_id int,quantity int,price NUMERIC(10, 2),foreign key(order_id) references Orders(order_id));
